        ...
        <div className="col-sm-6">
          <div className="white-box">
            <form className="form-material form-horizontal">
              ...
              <div className="form-group">
                <label className="col-md-12" htmlFor="cpwd">Page count
                </label>
                <div className="col-md-12">
                  <input type="number" id="cpwd" name="cpwd" className="form-control" placeholder="Count page" />
                </div>
              </div>
        ...
        <div className="col-sm-6">
          <div className="white-box">
            <form className="form-material form-horizontal">
              ...
              <div className="form-group">
                <label className="col-md-12" htmlFor="turl">Old Price
                </label>
                <div className="col-md-12">
              ...
              <div className="form-group">
                <label className="col-md-12" htmlFor="gurl">Actual Price
                </label>
                <div className="col-md-12">
              ...
              <div className="form-group">
                <label className="col-md-12" htmlFor="inurl">Cover of the Book
                </label>
                <div className="col-md-12">
              ...
              <div className="form-group">
                <label className="col-md-12" htmlFor="inurl"> Book
                </label>
                <div className="col-md-12">
                  <input type="file" id="inurl" name="inurl" className="form-control" />
                </div>
